...
func TestCreate(t *testing.T) {
	...
	n.Insert("128.143.12.12", 1985, 5)

	var r NukeRecord
	r, err = n.GetInfo("128.143.12.12")

	if err != nil || r.Expire != 1985 || r.Blocks != 5 {
	...
	err = n.InsertExpire("128.143.12.12", 1990)
	if err != nil {
	...
	if err != nil || r.Expire != 1990 || r.Blocks != 6 {
		t.Errorf("GetInfo after update failed %v %v\n", err, r)
	}

	err = n.InsertExpire("128.143.5.7", 1990)
	if err != nil {
		t.Errorf("InsertExpire failed %v\n", err)
	}
	...
	if err != nil || r.Expire != 1990 || r.Blocks != 1 {
